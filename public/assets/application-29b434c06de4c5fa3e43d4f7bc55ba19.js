...
(function() {
  $(".registr_box").bind("ajax:success", function(e, data, status, xhr) {
    if (data.success) {
      $('#sign_up').modal('hide');
      $('#sign_up_button').hide();
...
(function() {
  $(document).ready(function() {
    return $("#nav-shadow a").hover((function() {
      $(this).css("fontSize", "100px");
      return $(this).css("color", "blue");
    }), function() {
      $(this).css("fontSize", "1em");
      $(this).css("color", "black");
      return $(this).html("Я обычный параграф.");
    });
  });
